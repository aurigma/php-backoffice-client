...
class ProductVariantResourcePreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets height
     *
     * @param int|null $height Preview height in pixels.
     *
     * @return self
     */
     ...
     * Sets mockup_id
     *
     * @param string|null $mockup_id Mockup which is used to create preview.
     *
     * @return self
     */
     ...
     * Sets surface_index
     *
     * @param int|null $surface_index Design surface index which is used to create preivew.
     *
     * @return self
     */
