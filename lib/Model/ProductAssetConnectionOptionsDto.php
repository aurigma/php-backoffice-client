...
/**
 * ProductAssetConnectionOptionsDto Class Doc Comment
 *
 * @category Class
 * @description Product asset connection options description.
 * @package  Aurigma\BackOffice
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProductAssetConnectionOptionsDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductAssetConnectionOptionsDto';
    ...
    */
     ...
     * Sets option_id
     *
     * @param int|null $option_id Product option identifier.
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $option_value_ids Product option values identifiers.
     *
     * @return self
     */
    public function setOptionValueIds($option_value_ids)
    {
        if (is_null($option_value_ids)) {
            array_push($this->openAPINullablesSetToNull, 'option_value_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('option_value_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
