...
class ProductVariantDesignDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'design_name' => 'string',
        'design_group' => 'string',
        'design_has_data_schema' => 'bool',
        'design_has_toggle_set' => 'bool',
    ...
    protected static $openAPIFormats = [
        ...
        'design_name' => null,
        'design_group' => null,
        'design_has_data_schema' => null,
        'design_has_toggle_set' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'design_name' => true,
        'design_group' => true,
        'design_has_data_schema' => false,
        'design_has_toggle_set' => false,
    ...
    protected static $attributeMap = [
        ...
        'design_has_data_schema' => 'designHasDataSchema',
        'design_has_toggle_set' => 'designHasToggleSet',
    ...
    protected static $setters = [
        ...
        'design_has_data_schema' => 'setDesignHasDataSchema',
        'design_has_toggle_set' => 'setDesignHasToggleSet',
    ...
    protected static $getters = [
        ...
        'design_has_data_schema' => 'getDesignHasDataSchema',
        'design_has_toggle_set' => 'getDesignHasToggleSet',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('design_group', $data ?? [], null);
        $this->setIfExists('design_has_data_schema', $data ?? [], null);
        $this->setIfExists('design_has_toggle_set', $data ?? [], null);
    ...
    */
    ...
    public function setDesignName($design_name)
    {
        if (is_null($design_name)) {
            array_push($this->openAPINullablesSetToNull, 'design_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('design_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($design_group)) {
            array_push($this->openAPINullablesSetToNull, 'design_group');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('design_group', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets design_has_data_schema
     *
     * @return bool|null
     */
    public function getDesignHasDataSchema()
    {
        return $this->container['design_has_data_schema'];
    }

    /**
     * Sets design_has_data_schema
     *
     * @param bool|null $design_has_data_schema Design data schema tag. Indicates if design has data schema.
     *
     * @return self
     */
    public function setDesignHasDataSchema($design_has_data_schema)
    {
        if (is_null($design_has_data_schema)) {
            throw new \InvalidArgumentException('non-nullable design_has_data_schema cannot be null');
        }
        $this->container['design_has_data_schema'] = $design_has_data_schema;

        return $this;
    }

    /**
     * Gets design_has_toggle_set
     *
     * @return bool|null
     */
    public function getDesignHasToggleSet()
    {
        return $this->container['design_has_toggle_set'];
    }

    /**
     * Sets design_has_toggle_set
     *
     * @param bool|null $design_has_toggle_set Design toggle set tag. Indicated if design has toggle set.
     *
     * @return self
     */
    public function setDesignHasToggleSet($design_has_toggle_set)
    {
        if (is_null($design_has_toggle_set)) {
            throw new \InvalidArgumentException('non-nullable design_has_toggle_set cannot be null');
        }
        $this->container['design_has_toggle_set'] = $design_has_toggle_set;
